...
using vwg::tee::ClientCertInitializerAPI;
 ...
 */
std::shared_ptr<ClientCertInitializerAPI> ClientCertInitializerAPI::get_instance()
{
    return ClientCertTeeInterfaceClass::get_instance();
}
