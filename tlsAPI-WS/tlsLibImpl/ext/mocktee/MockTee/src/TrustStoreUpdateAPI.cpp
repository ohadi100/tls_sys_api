...
using vwg::tee::TrustStoreUpdateAPI;
 ...
 */
std::shared_ptr<TrustStoreUpdateAPI> TrustStoreUpdateAPI::get_instance()
{
    return TrustStoreUpdateTEEInterfaceClass::get_instance();
}
